...
console.log("Equality Test:", ("Nousheen" === "Nousheen"));
console.log("Equality Test:", ("Nousheen" === "Maria"));
//Inequality Case
console.log("Inequality Test:", ("Nousheen" !== "Nousheen"));
console.log("Inequality Test:", ("Nousheen" !== "Maria"));
//Tests using the lower case function
console.log("Lower Case Test:", "NOUSHEEN".toLowerCase() === "nousheen"); //true
console.log("Lower Case Test:", "NOUSHEEN".toLowerCase() === "NOUSHEEN"); //false
// Numerical tests involving equality and inequality, greater than and less than, greater than or equal to, and less than or equal to
console.log("Equalitiy Test:", 10 === 10); //true
console.log("Equalitiy Test:", 10 === 11); //false
console.log("Inequality Test:", 10 !== 9); //true
console.log("Inequality Test:", 10 !== 10); //false
